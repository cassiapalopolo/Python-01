'''
1. Faça um algoritmo para ler os seguintes números: A, B e C. Após, calcular o valor de D segundo a expressão: D = B² - 4AC, e mostrar os valores lidos e o resultado.
Ainda deve ser escrito o valor de D dividido por 2.
'''
